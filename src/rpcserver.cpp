...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ParadiseCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ParadiseCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ParadiseCoin features */
        {"ParadiseCoin", "masternode", &masternode, true, true, false},
        {"ParadiseCoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ParadiseCoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ParadiseCoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ParadiseCoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ParadiseCoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ParadiseCoin", "startmasternode", &startmasternode, true, true, false},
        {"ParadiseCoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ParadiseCoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ParadiseCoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ParadiseCoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ParadiseCoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ParadiseCoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ParadiseCoin", "mnbudget", &mnbudget, true, true, false},
        {"ParadiseCoin", "preparebudget", &preparebudget, true, true, false},
        {"ParadiseCoin", "submitbudget", &submitbudget, true, true, false},
        {"ParadiseCoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ParadiseCoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ParadiseCoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ParadiseCoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ParadiseCoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ParadiseCoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ParadiseCoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ParadiseCoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ParadiseCoin", "mnsync", &mnsync, true, true, false},
        {"ParadiseCoin", "spork", &spork, true, true, false},
        {"ParadiseCoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ParadiseCoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ParadiseCoind, or the -server option to ParadiseCoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ParadiseCoin-cli " + methodname + " " + args + "\n";
}
