/* src/config/ParadiseCoin-config.h.  Generated from ParadiseCoin-config.h.in by configure.  */
/* src/config/ParadiseCoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define this symbol if you have MSG_PRDIGNAL */
/* #undef HAVE_MSG_PRDIGNAL */
...
#define PACKAGE_BUGREPORT "www.ParadiseCoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "ParadiseCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "ParadiseCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ParadiseCoin"
