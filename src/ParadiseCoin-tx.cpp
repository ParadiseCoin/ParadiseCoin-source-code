...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ParadiseCoin Core ParadiseCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ParadiseCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ParadiseCoin transaction") + "\n" +
                               "  ParadiseCoin-tx [options] -create [commands]   " + _("Create hex-encoded ParadiseCoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ParadiseCoin transaction
