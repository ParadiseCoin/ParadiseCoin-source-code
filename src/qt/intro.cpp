...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ParadiseCoin Core"),
     ...
     * override -datadir in the ParadiseCoin.conf file in the default data directory
     * (to be consistent with ParadiseCoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
