...
public:
    ...
    void setZParadiseCoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzPRD_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzPRD_clicked();
    void on_pushButtonZParadiseCoinControl_clicked();
