...
/** Utility functions used by the ParadiseCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render ParadiseCoin addresses in moParadiseCoinpace font
...
// Parse "ParadiseCoin:" URI into recipient object, return true on successful parsing
