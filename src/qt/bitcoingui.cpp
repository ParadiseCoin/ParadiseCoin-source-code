                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ParadiseCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ParadiseCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ParadiseCoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zPRD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ParadiseCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about ParadiseCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ParadiseCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ParadiseCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ParadiseCoin addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagParadiseCointic information"));
    ...
    openAction->setStatusTip(tr("Open a ParadiseCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ParadiseCoin Core help message to get a list with possible ParadiseCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ParadiseCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ParadiseCoin network", "", count));
}
...
{
    QString strTitle = tr("ParadiseCoin Core"); // default title
...
/** Creates context menu, its actions, and ParadiseCoins up all the relevant signals for mouse events. */
