...
#define URI_SCHEME "ParadiseCoin"
...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a ParadiseCoin address (e.g. %1)").arg("PCYiHgGJJ6xGHqivmdZrYjRnhaYf6AJ2Mp"));
#endif
...
{
    // return if URI is not valid or is no ParadiseCoin: URI
...
{
    // Convert ParadiseCoin:// to ParadiseCoin:
    //
    //    Cannot handle this later, because ParadiseCoin:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open ParadiseCoin.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "ParadiseCoin.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for ParadiseCoin.lnk
...
{
    return GetAutostartDir() / "ParadiseCoin.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a ParadiseCoin.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=ParadiseCoin\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the ParadiseCoin app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add ParadiseCoin app to startup item list
