...
In order to support loading of multiple wallets in ParadiseCoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ParadiseCoin.cpp.
...
Changes to ParadiseCoin.cpp
----------------------
ParadiseCoin.cpp is the entry point into ParadiseCoin-qt, and as such, will require some minor modifications to provide hooks for
