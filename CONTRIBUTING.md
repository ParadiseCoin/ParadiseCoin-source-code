Contributing to ParadiseCoin Core
============================

The ParadiseCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ParadiseCoin Core project, and is not to be
confused with overall ParadiseCoin Network Protocol consensus changes.

Whether a pull request is merged into ParadiseCoin Core rests with the project merge
...
Patches that change ParadiseCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the ParadiseCoin consensus, it must have been
...
The project leader is the release manager for each ParadiseCoin Core release.
